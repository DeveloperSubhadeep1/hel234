...
Mᴇꜱꜱᴀɢᴇ : <b>{}</b>"""
    ...
    CAPTION = """<b><a href="https://t.me/Developer_Devil_01">{file_name}</a></b>\n\n<b>⚜️ Powered By : <a href=https://t.me/Developer_Devil_01>[The-Hell-King]</a></b>"""
...
🛠️ Bᴜɪʟᴅ Sᴛᴀᴛᴜs: <code> v3.8 [ Sᴛᴀʙʟᴇ ]</code>
</b>"""
...
│
├⋟ 🕵️ ᴀʟʟ ᴜsᴇʀs ⋟ <code>{}</code>
├⋟ 🔁 ᴛᴏᴛᴀʟ ᴍᴇꜱꜱᴀɢᴇꜱ ꜰᴇᴛᴄʜᴇᴅ ⋟ <code>{}</code>
...
├⋟ ✅ ᴛᴏᴛᴀʟ ᴍᴇssᴀɢᴇs sᴀᴠᴇᴅ ⋟ <code>{}</code>
├⋟ 📽️ ᴜsᴇᴅ sᴛᴏʀᴀɢᴇ ⋟ <code>{}</code>
├⋟ 🏷️ ꜰʀᴇᴇ sᴛᴏʀᴀɢᴇ ⋟ <code>{}</code>
│
<b>├────[ 🤖 ʙᴏᴛ ᴅᴇᴛᴀɪʟs 🤖 ]────⍟</b>   
