...
BOT_TOKEN = environ.get('BOT_TOKEN', "6753180750:AAED6WzJgGE1CQ3WtT6ort9E4UWm-j0JHiI")
...
# ============================
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6075512585 7785056863').split()]
...
OWNER_UPI_ID = environ.get('OWNER_UPI_ID', 'devefd@expl')
...
# User Configuration
# ============================
auth_users = [int(user) if id_pattern.search(user) else user for user in environ.get('AUTH_USERS', '27972068').split()]
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002107418598')).split()]
